...
#define MODE0_VUSBSEL_MASK	(0x1 << 2)
#define MODE0_VUSBSEL_VALUE	(0x1 << 2)
#define MODE0_VDACSTBY_VALUE   (0x1 << 5)
#define MODE0_VDACSTBY_MASK    (0x1 << 5)
#define REG_REGULATOR_MODE0_MASK	( MODE0_VDACSTBY_MASK | MODE0_VUSBSEL_MASK )
#define REG_REGULATOR_MODE0_VALUE	( MODE0_VDACSTBY_VALUE | MODE0_VUSBSEL_VALUE )
...
#define MX53_PCBA_MC34708_IRQ    (6*32 + 11)	/* GPIO7_11 */
