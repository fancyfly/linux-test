/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_hevc_dec_iq_it                                             */
/*  File     : med_hevc_dec_iq_it.h                                           */
/*                                                                            */
/*  Author   : reggen 1.55                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_HEVC_DEC_IQ_IT_H__
#define __MED_HEVC_DEC_IQ_IT_H__

/** @ingroup rdl
 *  @file med_hevc_dec_iq_it.h
 */
#define MED_HEVC_DEC_IQ_IT_IQ_REG          0x00000000
#define MED_HEVC_DEC_IQ_IT_SCALING_MATRIX  0x00000100
