/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_me_buffer                                                  */
/*  File     : med_me_buffer.h                                                */
/*                                                                            */
/*  Author   : reggen 1.56                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_ME_BUFFER_H__
#define __MED_ME_BUFFER_H__

/** @ingroup rdl
 *  @file med_me_buffer.h
 */
#define MED_ME_BUFFER_ME_BUFFER_LUMA         0x00000000
#define MED_ME_BUFFER_ME_BUFFER_CHROMA       0x00020000
