...
#define APS_IOCTL_APP_SET_DELAY	    _IOW(APSIO, 0x01, short)
#define APS_IOCTL_APP_GET_DELAY     _IOR(APSIO, 0x02, short)
#define APS_IOCTL_APP_SET_LFLAG	    _IOW(APSIO, 0x03, short)
#define APS_IOCTL_APP_GET_LFLAG	    _IOR(APSIO, 0x04, short)
#define APS_IOCTL_APP_SET_PFLAG	    _IOW(APSIO, 0x05, short)
#define APS_IOCTL_APP_GET_PFLAG	    _IOR(APSIO, 0x06, short)
