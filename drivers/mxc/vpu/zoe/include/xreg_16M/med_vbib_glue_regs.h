/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_vbib_glue_regs                                             */
/*  File     : med_vbib_glue_regs.h                                           */
/*                                                                            */
/*  Author   : reggen 1.56                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_VBIB_GLUE_REGS_H__
#define __MED_VBIB_GLUE_REGS_H__

/** @ingroup rdl
 *  @file med_vbib_glue_regs.h
 */
#define MED_VBIB_GLUE_REGS_CONFIG  0x00000000
