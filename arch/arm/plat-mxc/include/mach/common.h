...
extern int imx_src_reset_vpu(void);
extern int imx6q_src_init_ipu(int ipu_id);
static inline void imx6q_ipu_pg(int enable) {}
...
extern void imx_gpc_single_irq_mask(int irq, bool enable);
extern void imx_anatop_init(void);
extern void imx_anatop_pre_suspend(void);
extern void imx_anatop_post_resume(void);
extern void imx_anatop_set_stop_mode_config(bool enable);
extern unsigned int imx_anatop_get_core_reg_setting(void);
extern void imx_anatop_usb_chrg_detect_disable(void);
extern void imx_anatop_set_clk_get_delay(int);
