/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_mdma_hw_ls_reg                                             */
/*  File     : med_mdma_hw_ls_reg.h                                           */
/*                                                                            */
/*  Author   : reggen 1.55                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_MDMA_HW_LS_REG_H__
#define __MED_MDMA_HW_LS_REG_H__

/** @ingroup rdl
 *  @file med_mdma_hw_ls_reg.h
 */
#define MED_MDMA_HW_LS_REG_LS_BLOCK_ADDR  0x00000000
#define MED_MDMA_HW_LS_REG_LS_BLOCK_STAT  0x00000004
