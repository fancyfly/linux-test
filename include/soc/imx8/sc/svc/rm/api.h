 ...
 *                            changed
 * @param[in]     parent      handle of partition to set as parent
 *
 * @return Returns an error code (SC_ERR_NONE = success).
 *
 * Return errors:
...
/*!
 * This function flags a resource as movable or not.
 *
 * @param[in]     ipc         IPC handle
 * @param[in]     resource    resource for which flag should be set
 ...
 * @param[in]     start       start address of region (physical)
 * @param[in]     end         end address of region (physical)
 *
 * @return Returns an error code (SC_ERR_NONE = success).
 *
 * Return errors:
 ...
 * @param[out]    start       pointer to return start address
 * @param[out]    end         pointer to return end address
 *
 * @return Returns an error code (SC_ERR_NONE = success).
 *
 * Return errors:
