/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_hevc_mvp_xreg                                              */
/*  File     : med_hevc_mvp_xreg.h                                            */
/*                                                                            */
/*  Author   : reggen 1.55                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_HEVC_MVP_XREG_H__
#define __MED_HEVC_MVP_XREG_H__

/** @ingroup rdl
 *  @file med_hevc_mvp_xreg.h
 */
#define MED_HEVC_MVP_XREG_HEVC_MVP_SLICE_CFG      0x00000000
#define MED_HEVC_MVP_XREG_LAST_CTU_IN_SLICE_POS   0x00000004
