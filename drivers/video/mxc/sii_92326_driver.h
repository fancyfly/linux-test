...
///////////////////////////////////////////////////////////////////////////////
//
// I2C Slave addresses for four pages used by Sii 92326
//
#if (CI2CA_LOW_MHL == DISABLE)
...
///////////////////////////////////////////////////////////////////////////////
//
// I2C Indexed Register Offsets, Constants
//
...
//
//
#define	T_SRC_VBUS_CBUS_TO_STABLE	(200)	// DELAY ONLY 				// 100 - 1000 milliseconds. Per MHL 1.0 Specs
#define	T_SRC_WAKE_PULSE_WIDTH_1	(20)		// DELAY ONLY---Need to fine tune(+/-10% 18~22ms) 	// 20 milliseconds. Per MHL 1.0 Specs
#define	T_SRC_WAKE_PULSE_WIDTH_2	(60)		// DELAY ONLY---Need to fine tune(+/-10% 54~66ms)	// 60 milliseconds. Per MHL 1.0 Specs

#define	T_SRC_WAKE_TO_DISCOVER		(500)	// DELAY ONLY		// 100 - 1000 milliseconds. Per MHL 1.0 Specs
