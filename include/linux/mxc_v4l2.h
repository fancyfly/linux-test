...
#define V4L2_CID_SPECIAL_EFFECT		(V4L2_CID_PRIVATE_BASE + 4)

#define  V4L2_CID_MXC_SWITCH_CAM	(V4L2_CID_PRIVATE_BASE + 6)

#define V4L2_MXC_SPECIAL_EFFECT_NORMAL			1
#define V4L2_MXC_SPECIAL_EFFECT_NEGTIVE			2
#define V4L2_MXC_SPECIAL_EFFECT_BW			3

#define V4L2_MXC_WHITE_BALANCE_AUTO		1
#define V4L2_MXC_WHITE_BALANCE_CLOUDY1		2
#define V4L2_MXC_WHITE_BALANCE_SUNSHINE		3
#define V4L2_MXC_WHITE_BALANCE_CLOUDY2		4
#define V4L2_MXC_WHITE_BALANCE_DAYLIGHT		5
#define V4L2_MXC_WHITE_BALANCE_FILAMENTLIGHT	6
