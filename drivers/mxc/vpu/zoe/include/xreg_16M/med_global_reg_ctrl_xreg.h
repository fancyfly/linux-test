/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_global_reg_ctrl_xreg                                       */
/*  File     : med_global_reg_ctrl_xreg.h                                     */
/*                                                                            */
/*  Author   : reggen 1.56                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_GLOBAL_REG_CTRL_XREG_H__
#define __MED_GLOBAL_REG_CTRL_XREG_H__

/** @ingroup rdl
 *  @file med_global_reg_ctrl_xreg.h
 */
#define MED_GLOBAL_REG_CTRL_XREG_GLOBAL_REG 0x00000000
