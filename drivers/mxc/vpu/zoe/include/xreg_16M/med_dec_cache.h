/* ========================================================================== */
/*  Project  : cafe                                                           */
/*  Module   : med_dec_cache                                                  */
/*  File     : med_dec_cache.h                                                */
/*                                                                            */
/*  Author   : reggen 1.56                                                    */
/*  Created  :                                                                */
/* -------------------------------------------------------------------------- */
...
#ifndef __MED_DEC_CACHE_H__
#define __MED_DEC_CACHE_H__

/** @ingroup rdl
 *  @file med_dec_cache.h
 */
#define MED_DEC_CACHE_MC_CACHE       0x00000000
#define MED_DEC_CACHE_BLK_CTRL       0x00010000
